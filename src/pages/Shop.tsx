...
const Shop = () => {
  ...
  const allProducts: Product[] = [
    ...
    },
    {
      ...
      inStock: true,
      stockCount: 3,
      tags: ["traditional", "embroidery", "elegant"]
    },
    {
      id: 6,
    ...
    },
    {
      ...
      reviews: 28,
      isNew: true,
      description: "Vibrant Ankara print dress perfect for any occasion.",
      sizes: ["S", "M", "L", "XL"],
      colors: ["Multi", "Blue", "Red"],
      inStock: true,
      stockCount: 12,
      tags: ["ankara", "colorful", "african"]
    }
  ];
