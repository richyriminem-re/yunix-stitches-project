...
const Footer = () => {
  ...
  const services = [
    { name: "Custom Tailoring", href: "/services/custom-tailoring" },
    { name: "Bridal Couture", href: "/services/bridal" },
    { name: "Aso-Ebi Collections", href: "/services/aso-ebi" },
    { name: "Style Consultation", href: "/services/consultation" },
  ];
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-4 max-w-lg mx-auto">
              <Input 
                ...
                className="bg-white/10 border-white/30 text-white placeholder:text-white/70 focus:bg-white/20 dark:bg-black/20 dark:border-white/40 dark:focus:bg-black/30"
              />
