        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-10 lg:gap-12">
            ...
            <div className="sm:col-span-2 lg:col-span-2">
              <h2 className="text-2xl sm:text-3xl lg:text-4xl font-serif font-bold text-secondary mb-4 sm:mb-6">
                Yunix Stitches
              </h2>
              ...
              <div className="space-y-3 sm:space-y-4 mb-6 sm:mb-8">
                <div className="flex items-start space-x-3">
                  ...
                  <span className="text-sm sm:text-base leading-relaxed">Igbatoro Road, Opposite HOB (After Federal Secretariat),
Alagbaka, Akure, Ondo State, Nigeria</span>
              ...
              {/* Social Media */}
              <div>
                <h4 className="text-base sm:text-lg font-semibold mb-4 sm:mb-6">Follow Our Journey</h4>
                <div className="flex space-x-4">
                  ...
                  <a 
                    ...
                    className="group flex items-center justify-center w-10 h-10 sm:w-12 sm:h-12 rounded-full bg-gradient-to-br from-pink-500 via-purple-500 to-orange-500 hover:scale-110 transition-transform duration-300 shadow-lg"
                  >
                  ...
                  <a 
                    ...
                    target="_blank" 
                    rel="noopener noreferrer"
                    className="group flex items-center justify-center w-10 h-10 sm:w-12 sm:h-12 rounded-full bg-black hover:scale-110 transition-transform duration-300 shadow-lg relative overflow-hidden"
                  >
                    ...
                    <svg className="h-5 w-5 sm:h-6 sm:w-6 text-white group-hover:scale-110 transition-transform duration-300 relative z-10" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  <a 
                    ...
                    className="group flex items-center justify-center w-10 h-10 sm:w-12 sm:h-12 rounded-full bg-[#25D366] hover:scale-110 transition-transform duration-300 shadow-lg cursor-pointer"
                  >
                    <MessageCircle className="h-5 w-5 sm:h-6 sm:w-6 text-white group-hover:scale-110 transition-transform duration-300" />
                  </a>
                </div>
              </div>
            </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col sm:flex-row items-center justify-between space-y-4 sm:space-y-0">
            <div className="text-center sm:text-left opacity-90">
              <p className="text-sm sm:text-base">&copy; 2025 Yunix Stitches. All rights reserved.</p>
            </div>
